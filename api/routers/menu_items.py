...
@router.get("/category/{item_category}", response_model=list[schema.MenuItemRead])
def search_items(item_category: str, db: Session = Depends(get_db)):
    return controller.search_menu_items(db, item_category)
